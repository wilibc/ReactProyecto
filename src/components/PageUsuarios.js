...
const url = 'http://localhost:5000/usuarios';  //variable para usar la url
//const fileid = 'usu_id'

class PageUsuarios extends Component {

  state = {// crear componente para estados de cambio--- crear las variables
    ///// las variables modales o de estado renderizan o actualizan la parte del codigo cuando cambian de estado
    data:[],
    modalInsertar: false, //para ventanas modales
    modalEliminar: false,
    tipoModal:'',//para las variables de estado
    form:{ // variables para la toma de datos
      usu_id:'',
      usu_email:'',
      usu_clave:'',
      usu_nombres:'',
